$.fn.progressScroll=function(e){
    var r = $.extend({ width: 60, height: 60, borderSize: 5, mainBgColor: "var(--bs-primary)", lightBorderColor: "var(--bs-primary)", darkBorderColor: "var(--bs-primary)", fontSize: "20px" }, e);
    var t,
        i,
        n,
        o = this,
    ...
    this.updateProgress = function (e) {
        ...
        var r = (e * 360) / 100;
        if (r <= 180) {
            $("." + s, a).css("background-image", "linear-gradient(" + (90 + r) + "deg, transparent 50%, var(--bs-primary) 50%),linear-gradient(90deg, var(--bs-primary) 50%, transparent 50%)");
        } else {
            $("." + s, a).css("background-image", "linear-gradient(" + (r - 90) + "deg, transparent 50%, var(--bs-primary) 50%),linear-gradient(90deg, var(--bs-primary) 50%, transparent 50%)");
        }
        $("." + l, a).text();
    };
    //e+"%"
